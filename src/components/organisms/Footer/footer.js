...
const Footer = (_props) => {
  ...
  return (
    <Fragment>
      <footer
        className={`${classes[rootClassName]} py-4 px-4 lg:px-0 space-x-4 z-10 text-sm font-medium`}
      >
        <div className="container max-w-screen-xl mx-auto flex flex-wrap flex-row justify-between items-center px-4">
